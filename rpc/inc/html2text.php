...
/**
 * This script was taken from RoundCube Mail 0.31, as RoundCube
 * repaired a known remote code execution vulnerability and the original
 * source at chuggnutt.com was never patched.
 *
 * Modified html2text->_preg_callback
 *          strtolower() in switch to handle
 *          uppercase HTML tags <B><P> etc
 *
 * Michael Berkowski 15.Apr.2010
 * mjb@umn.edu
 */
