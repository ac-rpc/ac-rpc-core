{include file='page/rpc_pagestart.tpl'}
	...
	<p>
		If you already have an account, you may <a href='{$login_handler}?acct=login'>login</a>
		or <a href='{$application.relative_web_path}account?acct=newacct'>create a new account</a>.
	</p>
	<p>
